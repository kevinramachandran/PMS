    ...
    const PERMISSION_GROUPS = [
        ...
        },
        {
            ...
            items: [
                ...
                { key: 'INFO_PORTAL_VIEW', label: 'Info Portal View', description: 'Open the Info Portal button page.' },
                { key: 'INFO_PORTAL', label: 'Info Portal Configuration', description: 'Configure Info Portal button labels, URLs, and uploads.' },
