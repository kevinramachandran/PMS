...
import org.example.service.AbnormalityMasterDataService;
...
@RestController
@RequestMapping("/api/dashboard-config/abnormality-master-data")
@CrossOrigin
public class AbnormalityMasterDataController {

    private final AbnormalityMasterDataService service;

    public AbnormalityMasterDataController(AbnormalityMasterDataService service) {
    ...
    private Map<String, Object> success(List<AbnormalityMasterDataItem> items) {
    ...
    private Map<String, Object> success(AbnormalityMasterDataItem item) {
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("status", "success");
