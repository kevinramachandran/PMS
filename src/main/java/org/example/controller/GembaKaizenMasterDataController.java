...
import org.example.service.GembaKaizenMasterDataService;
...
@RestController
@RequestMapping("/api/dashboard-config/gemba-kaizen-master-data")
@CrossOrigin
public class GembaKaizenMasterDataController {

    private final GembaKaizenMasterDataService service;

    public GembaKaizenMasterDataController(GembaKaizenMasterDataService service) {
    ...
    private Map<String, Object> success(List<GembaKaizenMasterDataItem> items) {
    ...
    private Map<String, Object> success(GembaKaizenMasterDataItem item) {
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("status", "success");
