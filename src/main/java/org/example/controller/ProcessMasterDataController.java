...
import org.example.service.ProcessMasterDataService;
...
@RestController
@RequestMapping("/api/dashboard-config/process-master-data")
@CrossOrigin
public class ProcessMasterDataController {

    private final ProcessMasterDataService service;

    public ProcessMasterDataController(ProcessMasterDataService service) {
    ...
    private Map<String, Object> success(List<ProcessMasterDataItem> items) {
    ...
    private Map<String, Object> success(ProcessMasterDataItem item) {
        Map<String, Object> payload = new LinkedHashMap<>();
        payload.put("status", "success");
